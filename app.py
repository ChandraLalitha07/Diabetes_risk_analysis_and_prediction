...
MentHlth = st.number_input("Days of Poor Mental Health (0-30)", min_value=0, max_value=30, step=1)
PhysHlth = st.number_input("Days of Poor Physical Health (0-30)", min_value=0, max_value=30, step=1)
